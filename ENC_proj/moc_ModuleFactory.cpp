...
struct qt_meta_stringdata_RW__ENC__ModuleFactory_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RW__ENC__ModuleFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RW__ENC__ModuleFactory_t qt_meta_stringdata_RW__ENC__ModuleFactory = {
    {
QT_MOC_LITERAL(0, 0, 22) // "RW::ENC::ModuleFactory"

    },
    "RW::ENC::ModuleFactory"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_RW__ENC__ModuleFactory[] = {
...
void RW::ENC::ModuleFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject RW::ENC::ModuleFactory::staticMetaObject = {
    { &CORE::AbstractModuleFactory::staticMetaObject, qt_meta_stringdata_RW__ENC__ModuleFactory.data,
      qt_meta_data_RW__ENC__ModuleFactory,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *RW::ENC::ModuleFactory::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *RW::ENC::ModuleFactory::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_RW__ENC__ModuleFactory.stringdata0))
...
int RW::ENC::ModuleFactory::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
using namespace RW;
using namespace RW::ENC;
QT_MOC_EXPORT_PLUGIN(RW::ENC::ModuleFactory, ModuleFactory)
