...
#define NV_ENC_CUDA 2
            ...
            typedef struct _EncodeConfig
            {
                ...
                _EncodeConfig() : nWidth(0), nHeight(0), maxWidth(0), maxHeight(0),
            ...
            public:
                ...
                NVENCSTATUS ProcessOutput(const EncodeBuffer *pEncodeBuffer, RW::tstBitStream *pBitstream);
