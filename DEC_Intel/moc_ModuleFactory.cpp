...
struct qt_meta_stringdata_RW__DEC__ModuleFactory_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RW__DEC__ModuleFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RW__DEC__ModuleFactory_t qt_meta_stringdata_RW__DEC__ModuleFactory = {
    {
QT_MOC_LITERAL(0, 0, 22) // "RW::DEC::ModuleFactory"

    },
    "RW::DEC::ModuleFactory"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_RW__DEC__ModuleFactory[] = {
...
void RW::DEC::ModuleFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject RW::DEC::ModuleFactory::staticMetaObject = {
    { &CORE::AbstractModuleFactory::staticMetaObject, qt_meta_stringdata_RW__DEC__ModuleFactory.data,
      qt_meta_data_RW__DEC__ModuleFactory,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *RW::DEC::ModuleFactory::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *RW::DEC::ModuleFactory::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_RW__DEC__ModuleFactory.stringdata0))
...
int RW::DEC::ModuleFactory::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
using namespace RW;
using namespace RW::DEC;
QT_MOC_EXPORT_PLUGIN(RW::DEC::ModuleFactory, ModuleFactory)
