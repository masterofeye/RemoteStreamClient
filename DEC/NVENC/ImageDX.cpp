    ...
    , bIsCudaResource_(false)
{
    ...
    aVertexBuffer_[0] = VertexStruct(-1.0f, -1.0f, 0.0f, 0.0f, 1.0f);
    aVertexBuffer_[1] = VertexStruct( 1.0f, -1.0f, 0.0f, 1.0f, 1.0f);
    aVertexBuffer_[2] = VertexStruct( 1.0f,  1.0f, 0.0f, 1.0f, 0.0f);
    aVertexBuffer_[3] = VertexStruct(-1.0f,  1.0f, 0.0f, 0.0f, 0.0f);
